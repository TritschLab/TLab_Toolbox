...
%       'burst.on' - (idx) burst onset as index of spikeTimes
%       'burst.off' - (idx) burst offset as index of spikeTimes
%
...
%burstArray = cell(numRegions,1); burstIdx = cell(numRegions,1);
for k = 1:numRegions
